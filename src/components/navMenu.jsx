    ...
    <>
      ...
      <div className="relative" ref={containerRef}>
        ...
        >
          <ul
            ref={navRef}
            className="flex flex-wrap justify-center lg:justify-end gap-4 md:gap-8 list-none px-4 py-2 m-0 relative z-[3] w-full"
            style={{
              color: "white",
            ...
            {items.map((item, index) => (
              ...
              >
                <span
                  ...
                  className="outline-none text-sm md:text-base text-gray-400 font-bold hidden md:block"
                >
                  {item.label}
                </span>
                ...
                <span
                  tabIndex={0}
                  onKeyDown={(e) => handleKeyDown(e, index)}
                  className="outline-none text-sm md:text-base text-gray-700 font-bold block md:hidden"
                >
                  {item.icon}
                </span>
              </li>
